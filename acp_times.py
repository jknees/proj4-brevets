...
def open_time( control_dist_km, brevet_dist_km, brevet_start_time ):
    ...
    print("hour= " + str(hour))
    return brevet_start_time.replace(hours=+hour, minutes=+(int(60*minute, 0)))
...
def close_time( control_dist_km, brevet_dist_km, brevet_start_time ):
    ...
    minute, hour = math.modf(control_close_time)
    print("hour= " + str(hour) + " minute= " + str(int(60*minute, 0)))
    return brevet_start_time.replace(hour=+hour, minute=+(int(60*minute, 0)))
